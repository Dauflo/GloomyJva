        ...
        <div class="form-center">
            <div class="center-div-login">
                <form action="/auth/shareunsharedir" method="post">
                    <h5>Current path : <c:out value="${path}"/></h5><br/>
                    <input type="hidden" value="${directory.getId()}" name="id"/>
                    <input class="end-form genric-btn primary circle arrow" type="submit" value="State : ${directory.getSharedString()}"/>
                </form><br>
                <c:if test="${directory.isShared()}">
        ...
        <div class="form-center">
            <div class="center-div-login">
                <form method="post" action="/auth/updatedirectoryname">
                    <h5>Update current directory name</h5><br/>
                    <input type="hidden" value="${directory.getId()}" name="directoryId"/>
                    <input type="text" name="name" placeholder="New name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'New name'" required class="single-input-reverse">
                    <br/>
...
<div class="section-top-border">
    <div class="progress-table">
        <div class="dir-path"> Files in Root > <c:out value="${path}"/></div>
...
<div class="section-top-border">
    <div class="progress-table">
        <div class="dir-path"> Folders in Root > <c:out value="${path}"/></div>
        <div class="table-head">
        ...
        <c:forEach items="${directories}" var="subDirectory">
            <div class="table-row">
                ...
                <div class="dir-name"><c:out value="${subDirectory.getName()}"/></div>
                <div class="dir-see">
